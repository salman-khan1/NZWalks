...
{
    /// <inheritdoc />
    public partial class Seedingdatafordifficulitesandregions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("13d106b9-543a-4621-98d5-eb91dfce6a78"), "Easy" },
                    { new Guid("71143d67-5990-4b1a-8ca6-c4ad3fc6d2d5"), "Hard" },
                    { new Guid("cf272177-720e-425f-8805-71c6832ca60a"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("13d106b9-543a-4621-98d5-eb91dfce6a78"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("71143d67-5990-4b1a-8ca6-c4ad3fc6d2d5"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("cf272177-720e-425f-8805-71c6832ca60a"));
